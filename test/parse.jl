...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:01\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:01Z\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.001\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.001Z\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.000001\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.000001Z\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.000000001\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-01-01T00:00:00.000000001Z\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-02-03T04:05:06.789123456\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Timestamp64(\"2021-02-03T04:05:06.789123456Z\")" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Base.parse(Timestamp64, [iso 8601 strings])" begin
    using Dates
    using Timestamps64

    cases = [
        ("2021-02-03T04:05:06.789123456", Timestamp64(2021, 2, 3, 4, 5, 6; nanoseconds=789123456)),
        ("2021-02-03T04:05:06.789123456Z", Timestamp64(2021, 2, 3, 4, 5, 6; nanoseconds=789123456)),
        ("2021-02-03T04:05:06.789123", Timestamp64(2021, 2, 3, 4, 5, 6; nanoseconds=789123000)),
        ("2021-02-03T04:05:06.789123Z", Timestamp64(2021, 2, 3, 4, 5, 6; nanoseconds=789123000)),
...
@testitem "Parse: Base.parse(Timestamp64, [iso 8601 strings], Dates.ISODateTimeFormat)" begin
    using Dates
    using Timestamps64
...
@testitem "Parse: Base.parse(Timestamp64, [iso 8601 strings], ISOTimestamp64Format)" begin
    using Dates
    using Timestamps64
