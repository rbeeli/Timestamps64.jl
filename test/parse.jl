...
@testset verbose = true "Parse" begin
    ...
    @testset "Base.parse(Timestamp64, [iso 8601 strings])" begin
        cases = [
            ("2021-02-03T04:05:06.789123456", Timestamp64(2021, 2, 3, 4, 5, 6, 789123456)),
            ("2021-02-03T04:05:06.789123456Z", Timestamp64(2021, 2, 3, 4, 5, 6, 789123456)),
            ("2021-02-03T04:05:06.789123", Timestamp64(2021, 2, 3, 4, 5, 6, 789123000)),
            ("2021-02-03T04:05:06.789123Z", Timestamp64(2021, 2, 3, 4, 5, 6, 789123000)),
            ("2021-02-03T04:05:06.789", Timestamp64(2021, 2, 3, 4, 5, 6, 789000000)),
            ("2021-02-03T04:05:06.789Z", Timestamp64(2021, 2, 3, 4, 5, 6, 789000000)),
            ("2021-02-03T04:05:06", Timestamp64(2021, 2, 3, 4, 5, 6, 0)),
            ("2021-02-03T04:05:06Z", Timestamp64(2021, 2, 3, 4, 5, 6, 0)),
        ]
